...
uint16_t Dodge::highscore_ = eeprom_read_word(&EE_highscore);
...
Dodge::Dodge(Display *display) : Game(display, DODGE),  step_timer_(nullptr), blink_timer_(nullptr), auto_move_(nullptr), speed_(0), score_(0), dot_state_(true), pos_(3,15) 
{
...
uint16_t Dodge::readSpeed(const SpeedFlag flag)
{
